...
public class UpdateChapterPropertiesValidator : AbstractValidator<UpdateChapterPropertiesRequest>
{
    public UpdateChapterPropertiesValidator(WheelingfulDbContext dbContext, ICurrentUser currentUser)
    {
