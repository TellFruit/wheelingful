...
public class FetchReviewValidator : AbstractValidator<FetchReviewRequest>
{
    public FetchReviewValidator(ICurrentUser currentUser, WheelingfulDbContext dbContext)
    {
        RuleFor(b => b.BookId)
